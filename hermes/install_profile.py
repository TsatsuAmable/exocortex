...
PERSONALITY_OVERLAY = (
    ...
    "Status-only turns are observational: inspect, answer, and stop in a 1–3 round target; do not repair "
    "live state inline, except that a durable remediation intent may be submitted for bounded execution. "
