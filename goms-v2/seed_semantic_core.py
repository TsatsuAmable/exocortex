...
with closing(sqlite3.connect(DB)) as c, c:
    ...
    memory=ins_entity(c,"idea","Cross-session persistent memory","Persistent memory available across sessions.")
    ...
    assert_(c,goms,"implements",memory,literal="Cross-session persistent memory",confidence=1.0)
