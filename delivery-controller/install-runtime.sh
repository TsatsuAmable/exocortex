...
chmod +x "$RUNTIME_DIR/delivery.py" "$RUNTIME_DIR/workspace.py" "$RUNTIME_DIR/nemosyne_continuous.py" "$RUNTIME_DIR/tick_all.py"

python3 -m py_compile "$RUNTIME_DIR/delivery.py" "$RUNTIME_DIR/workspace.py" "$RUNTIME_DIR/nemosyne_continuous.py" "$RUNTIME_DIR/tick_all.py"
